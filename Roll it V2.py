...
make_statment("welcome to the roll it 13 game", "@")
...
while comp_score < game_goal and user_score < game_goal:
    ...
    #start of round loop
    make_statment(f"Round {rounds_played}", "$")
# Roll the dice for the user and note if they got a double
    ...
    # Generate round and add it to the game history list
